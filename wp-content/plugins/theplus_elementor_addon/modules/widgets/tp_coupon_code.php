...
class ThePlus_Coupon_Code extends Widget_Base {
    ...
    protected function _register_controls() {
	 ...
	 protected function render() {
		...
		$clickAction = $visitLink = $modelClsIcon = '';
		if($actionType == 'click') {
		...
		$output = '';
		$output .= '<div id="tp-widget-'.$uid_ccd.'" class="tp-coupon-code action-'.$actionType.' coupon-code-'.esc_attr($couponType).''.esc_attr($slide_out_class).' tp-widget-'.esc_attr($uid_ccd).'" data-tp_cc_settings=\'' .$coupon_code_attr. '\'>';
			if($couponType == 'standard') {
				$output .= '<div class="coupon-code-inner '.esc_attr($standardStyle).'">';
					...
					if($actionType == 'popup') {
						...
						$output .= '<div class="ccd-main-modal copy-'.$copyCodeStyle.'" role="alert">';
