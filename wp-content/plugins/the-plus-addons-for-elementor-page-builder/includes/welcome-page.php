		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">June 29,2022 <span class="changelog-version">Lite Version 5.1.0</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Update : Container Compatibility : Live Copy','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Post Meta : Taxonomies Type option (Category/Tag)','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Wrapper Link : Container Compatibility','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">June 29,2022 <span class="changelog-version">Pro Version 5.1.0</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Update : Heading Title : Animated Split by Word','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Unfold : Container option','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Product Listing : Upsells Listing','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Product Listing : Cross Sells Listing','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Search bar : Search by Word Match','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
